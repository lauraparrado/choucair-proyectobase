...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanLauraWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) {
    ...
    public void sheFindsTheCourseCalled(List<AcademyChoucairData> academyChoucairData) {
